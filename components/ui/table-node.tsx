                ...
                <DropdownMenuContent align="start" className="min-w-48">
                  <DropdownMenuGroup>
                    ...
                    <DropdownMenuItem
                      ...
                      onMouseDown={(e) => e.preventDefault()}
                    >
                      <BetweenHorizontalStartIcon className="rotate-180" />
                      Row below
                    </DropdownMenuItem>
                    <DropdownMenuItem
                    ...
                    <DropdownMenuItem
                      ...
                      onMouseDown={(e) => e.preventDefault()}
                    >
                      <BetweenVerticalStartIcon className="rotate-180" />
                      Column right
                    </DropdownMenuItem>
                  </DropdownMenuGroup>
                </DropdownMenuContent>
  ...
  return (
    <div contentEditable={false}>
      <Button
        ...
        title="Add row"
        className={cn(
          'absolute -bottom-3 left-1/2 z-40 size-6 -translate-x-1/2 rounded-full p-0 shadow-sm',
      ...
      <Button
        ...
        title="Add column"
        className={cn(
          'absolute top-1/2 -right-3 z-40 size-6 -translate-y-1/2 rounded-full p-0 shadow-sm',
          'opacity-0 transition-opacity group-hover/table:opacity-100'
        )}
        onMouseDown={(e) => e.preventDefault()}
        onClick={() => {
